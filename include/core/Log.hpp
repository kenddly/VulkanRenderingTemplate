...
#define LOG_TRACE(...) ::vks::Log::PushLogMessage(spdlog::level::trace, fmt::format(__VA_ARGS__))
#define LOG_INFO(...) ::vks::Log::PushLogMessage(spdlog::level::info, fmt::format(__VA_ARGS__))
#define LOG_ERROR(...) ::vks::Log::PushLogMessage(spdlog::level::err, fmt::format(__VA_ARGS__))
#define LOG_WARN(...) ::vks::Log::PushLogMessage(spdlog::level::warn, fmt::format(__VA_ARGS__))
#define LOG_CRITICAL(...) ::vks::Log::PushLogMessage(spdlog::level::critical, fmt::format(__VA_ARGS__))
